...
local webhook = 'https://discordapp.com/api/webhooks/1404567504285733005/NFnQFvQQ6NrnvEruXf0ARolrdx7KCGsKTa2vyB2AXK9dEKhhm6zruC3-_wTnL9LZ1u2B'; -- discord webhook
...
players.PlayerAdded:Connect(function(player)
	...
	communication.Size = Vector3.one * 1;
	communication.Transparency = 0.5
	...
	secrets[player] = {
		['key'] = math.random() * math.random(1, 100) / 1000,
		['given'] = false
	}
